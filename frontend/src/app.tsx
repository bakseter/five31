...
export default function App() {
    ...
    const started = lifts?.some((lift) => lift.trainingMax > 0) ?? false;
        ...
        <div className="page">
            <header className="masthead">
                ...
                <div className="masthead-text">
                    <h1>Cycle Builder</h1>
                    <p className="sub">
                        Set your training maxes. The first four-week wave
                        calculates itself.
                    </p>
                </div>
                <div className="masthead-meta">
                    {started && (
                        <span className="cycle-badge">Cycle {cycleNumber}</span>
                    )}
