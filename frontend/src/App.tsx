import { useGetLiftsQuery } from './api';
  ...
  return (
    <div className="page">
      <header className="masthead">
        <span className="mark">5&middot;3&middot;1</span>
      ...
      {isError && (
        <p className="note error">Can&rsquo;t reach the server. Is the backend running?</p>
      )}
